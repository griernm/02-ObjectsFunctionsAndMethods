...
def main():
    ...
    #better_draw_circles(rg.Point(-200, 10), 3)
    even_better_draw_circles(rg.Point(100, 50), 15, 11, 'red', 6)
    even_better_draw_circles(rg.Point(-200, 10), 10, 6, 'green', 3)
    even_better_draw_circles(rg.Point(-150, 30), 20, 4, 'purple', 10)
    even_better_draw_circles(rg.Point(-50, 40), 3, 50, 'blue', 1)
    window.update()
