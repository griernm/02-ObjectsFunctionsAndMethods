...
def turtle(color, thickness):
    ...
    big_turtle = rg.SimpleTurtle()
    small_turtle = rg.SimpleTurtle()
    big_turtle.pen = rg.Pen('green', thickness)
    small_turtle.pen = rg.Pen(color, 5)
    big_turtle.forward(100)
    small_turtle.backward(100)
